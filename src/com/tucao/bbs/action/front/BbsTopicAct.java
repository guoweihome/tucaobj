...
import static com.tucao.bbs.entity.BbsTopic.TOPIC_NORMAL;
import static com.tucao.bbs.entity.BbsTopic.TOPIC_VOTE;
...
import com.tucao.bbs.entity.BbsCategory;
...
public class BbsTopicAct {
	...
	public String upOrDownSubmit(Integer[] topicIds, Integer forumId,
		...
		if (msg != null) {
			model.put("msg", msg);
			return FrontUtils.getTplPath(request, site.getSolutionPath(),TPLDIR_TOPIC, TPL_NO_VIEW);
		}
	...
	public String primeInput(Integer[] topicIds, Integer forumId,
		...
		model.put("topicIds", topicIds);
		return FrontUtils.getTplPath(request, site.getSolutionPath(),TPLDIR_TOPIC, TPL_TOPIC_PRIME);
	}
	...
	public String upTopInput(Integer[] topicIds, Integer forumId,
		...
		model.put("topicIds", topicIds);
		return FrontUtils.getTplPath(request, site.getSolutionPath(),TPLDIR_TOPIC, TPL_TOPIC_UPTOP);
	}
	...
	public String highlightInput(Integer[] topicIds, Integer forumId,
		...
		model.put("topicIds", topicIds);
		return FrontUtils.getTplPath(request, site.getSolutionPath(),TPLDIR_TOPIC, TPL_TOPIC_HIGHLIGHT);
	}
	...
	public String searchByDay(Integer forumId, Integer day,HttpServletRequest request, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		BbsUser user = CmsUtils.getUser(request);
		FrontUtils.frontData(request, model, site);
		BbsForum forum = bbsForumMng.findById(forumId);
		...
		return FrontUtils.getTplPath(request, site.getSolutionPath(),TPLDIR_TOPIC, TPL_DAY_TOPIC);
	}
	...
	public String result(Integer tid, HttpServletRequest request,HttpServletResponse response, ModelMap model) {
		...
		FrontUtils.frontData(request, model, site);
		return FrontUtils.getTplPath(request, site.getSolutionPath(),TPLDIR_TOPIC, TPL_TOPIC_VOTERESULT);
	}
