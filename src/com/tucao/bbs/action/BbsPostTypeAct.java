...
import com.tucao.common.web.WebErrors;
import com.tucao.core.entity.CmsSite;

import static com.tucao.common.page.SimplePage.cpn;
...
//		if(parentId!=null&&parentId==posttype.getId()){
//			return list(forumId, null, pageNo, request, model);
//
//		}else{
			return list(forumId, parentId, pageNo, request, model);
	...
	private boolean vldExist(Integer id, WebErrors errors) {
		...
		if (errors.ifNotExistByDao(entity, BbsPostType.class, id)) {
			return true;
		}
		return false;
	}
