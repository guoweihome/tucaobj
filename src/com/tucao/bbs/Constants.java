...
public class Constants {
	 ...
	 * 首页模板
	 */
	public static final String TPLDIR_HOME = "home";
	 ...
	 * 用户登录	模板
	 */
	public static final String TPLDIR_USERLOGIN = "user";
	
	public static final String TPLDIR_INCLUDE = "include";
	/**
	 * 最近的吐槽	模板
	 */
	public static final String TPLDIR_SHUOSH = "shuosh";
