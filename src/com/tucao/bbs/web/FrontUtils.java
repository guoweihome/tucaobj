...
import static com.tucao.bbs.Constants.RES_PATH;
import static com.tucao.bbs.Constants.TPLDIR_COMMON;
import static com.tucao.bbs.Constants.TPLDIR_STYLE_LIST;
import static com.tucao.bbs.Constants.TPLDIR_TAG;
import static com.tucao.bbs.Constants.TPL_STYLE_PAGE_CHANNEL;
import static com.tucao.bbs.Constants.TPL_STYLE_PAGE_TOPIC;
import static com.tucao.bbs.Constants.TPL_SUFFIX;
import static com.tucao.common.web.Constants.MESSAGE;
import static com.tucao.common.web.Constants.UTF8;
import static com.tucao.common.web.ProcessTimeFilter.START_TIME;
import static com.tucao.common.web.freemarker.DirectiveUtils.PARAM_TPL_SUB;
...
import com.tucao.core.web.front.URLHelper.PageInfo;
...
public class FrontUtils {
	...
	public static String showError(HttpServletRequest request,
		...
		return getTplPath(request, site.getSolutionPath(), TPLDIR_COMMON,ERROR_PAGE);
	}
	...
	public static void frontData(Map<String, Object> map, CmsSite site,
		...
		String res = ctxPath + RES_PATH + "/" + site.getPath() + "/"+ site.getTplSolution();
		// res路径需要去除第一个字符'/'
		map.put(RES_TPL, res.substring(1));
		map.put(LOCATION, location);
		//map.put("qqlogin", "0");//zqc sb code
	}
	
	public static String getResPath(CmsSite site){
		String ctxPath = site.getContextPath();
		if ((ctxPath + "").equals("null")) {
			ctxPath = "";
		}
