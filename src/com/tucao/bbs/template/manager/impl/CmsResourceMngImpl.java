package com.tucao.bbs.template.manager.impl;

import static com.tucao.bbs.web.FrontUtils.RES_EXP;
import static com.tucao.common.web.Constants.SPT;
...
import com.tucao.bbs.template.manager.CmsResourceMng;
import com.tucao.bbs.web.FrontUtils;
import com.tucao.common.file.FileWrap;
import com.tucao.common.file.FileWrap.FileComparator;
import com.tucao.common.util.Zipper.FileEntry;
...
public class CmsResourceMngImpl implements CmsResourceMng {
	...
	public List<FileWrap> listFile(String path, boolean dirAndEditable) {
		...
		System.out.println("result:"+realPathResolver.get(path));
		if (parent.exists()) {
			File[] files;
			if (dirAndEditable) {
