...
public abstract class BaseBbsReportExt  implements Serializable {
	...
	// many to one
	private com.tucao.bbs.entity.BbsUser reportUser;
	private com.tucao.bbs.entity.BbsReport report;
	 ...
	 */
	public com.tucao.bbs.entity.BbsUser getReportUser () {
		return reportUser;
	}
	 ...
	 */
	public void setReportUser (com.tucao.bbs.entity.BbsUser reportUser) {
	 ...
	 */
	public com.tucao.bbs.entity.BbsReport getReport () {
		return report;
	}
	 ...
	 */
	public void setReport (com.tucao.bbs.entity.BbsReport report) {
		this.report = report;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.bbs.entity.BbsReportExt)) return false;
		else {
			com.tucao.bbs.entity.BbsReportExt bbsReportExt = (com.tucao.bbs.entity.BbsReportExt) obj;
