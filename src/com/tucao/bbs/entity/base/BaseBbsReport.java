...
public abstract class BaseBbsReport  implements Serializable {
	...
	// many to one
	private com.tucao.bbs.entity.BbsUser processUser;

	// collections
	private java.util.Set<com.tucao.bbs.entity.BbsReportExt> bbsReportExtSet;
	 ...
	 */
	public com.tucao.bbs.entity.BbsUser getProcessUser () {
		return processUser;
	}
	 ...
	 */
	public void setProcessUser (com.tucao.bbs.entity.BbsUser processUser) {
	 ...
	 */
	public java.util.Set<com.tucao.bbs.entity.BbsReportExt> getBbsReportExtSet () {
	 ...
	 */
	public void setBbsReportExtSet (java.util.Set<com.tucao.bbs.entity.BbsReportExt> bbsReportExtSet) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.bbs.entity.BbsReport)) return false;
		else {
			com.tucao.bbs.entity.BbsReport bbsReport = (com.tucao.bbs.entity.BbsReport) obj;
