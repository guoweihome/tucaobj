...
public abstract class BaseBbsUser implements Serializable {
	 ...
	 */
	public BaseBbsUser(java.lang.Integer id,
			com.tucao.bbs.entity.BbsUserGroup group,
	...
	// one to one
	private com.tucao.bbs.entity.BbsUserOnline userOnline;

	// many to one
	private com.tucao.bbs.entity.BbsUserGroup group;

	// collections
	private java.util.Set<com.tucao.bbs.entity.BbsUserExt> userExtSet;
	private java.util.Set<com.tucao.bbs.entity.BbsLoginLog> loginLogs;
	private java.util.Set<com.tucao.bbs.entity.BbsMemberMagic> memberMagics;
	...
	public com.tucao.bbs.entity.BbsUserOnline getUserOnline() {
		return userOnline;
	}

	public void setUserOnline(com.tucao.bbs.entity.BbsUserOnline userOnline) {
	 ...
	 */
	public com.tucao.bbs.entity.BbsUserGroup getGroup() {
		return group;
	}
	 ...
	 *            the group_id value
	 */
	public void setGroup(com.tucao.bbs.entity.BbsUserGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.tucao.bbs.entity.BbsUserExt> getUserExtSet() {
		return userExtSet;
	}
	...
	public void setUserExtSet(
			java.util.Set<com.tucao.bbs.entity.BbsUserExt> userExtSet) {
		this.userExtSet = userExtSet;
	}

	public java.util.Set<com.tucao.bbs.entity.BbsLoginLog> getLoginLogs() {
		return loginLogs;
	}

	public void setLoginLogs(
			java.util.Set<com.tucao.bbs.entity.BbsLoginLog> loginLogs) {
		this.loginLogs = loginLogs;
	}

	

	public java.util.Set<com.tucao.bbs.entity.BbsMemberMagic> getMemberMagics() {
		return memberMagics;
	}

	public void setMemberMagics(
			java.util.Set<com.tucao.bbs.entity.BbsMemberMagic> memberMagics) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.tucao.bbs.entity.BbsUser))
			return false;
		else {
			com.tucao.bbs.entity.BbsUser bbsUser = (com.tucao.bbs.entity.BbsUser) obj;
