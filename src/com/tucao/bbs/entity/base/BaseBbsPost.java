...
public abstract class BaseBbsPost  implements Serializable {
	...
	public BaseBbsPost (
		...
		com.tucao.bbs.entity.BbsConfig config,
		com.tucao.bbs.entity.BbsTopic topic,
	...
	// one to one
	private com.tucao.bbs.entity.BbsPostText postText;

	// many to one
	private com.tucao.core.entity.CmsSite site;
	private com.tucao.bbs.entity.BbsConfig config;
	private com.tucao.bbs.entity.BbsTopic topic;
	private com.tucao.bbs.entity.BbsUser creater;
	private com.tucao.bbs.entity.BbsUser editer;
	private com.tucao.bbs.entity.BbsPostType postType;

	// collections
	private java.util.Set<com.tucao.bbs.entity.BbsGrade> grade;
	private java.util.Set<com.tucao.bbs.entity.Attachment> attachments;
	 ...
	 */
	public com.tucao.bbs.entity.BbsPostText getPostText () {
		return postText;
	}
	 ...
	 */
	public void setPostText (com.tucao.bbs.entity.BbsPostText postText) {
	 ...
	 */
	public com.tucao.bbs.entity.BbsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.tucao.bbs.entity.BbsConfig config) {
		this.config = config;
	}
	 ...
	 */
	public com.tucao.bbs.entity.BbsTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.tucao.bbs.entity.BbsTopic topic) {
		this.topic = topic;
	}
	 ...
	 */
	public com.tucao.bbs.entity.BbsUser getCreater () {
		return creater;
	}
	 ...
	 */
	public void setCreater (com.tucao.bbs.entity.BbsUser creater) {
	 ...
	 */
	public com.tucao.bbs.entity.BbsUser getEditer () {
		return editer;
	}
	 ...
	 */
	public void setEditer (com.tucao.bbs.entity.BbsUser editer) {
		this.editer = editer;
	}

	public com.tucao.bbs.entity.BbsPostType getPostType() {
		return postType;
	}

	public void setPostType(com.tucao.bbs.entity.BbsPostType postType) {
	 ...
	 */
	public java.util.Set<com.tucao.bbs.entity.BbsGrade> getGrade () {
		return grade;
	}
	 ...
	 */
	public void setGrade (java.util.Set<com.tucao.bbs.entity.BbsGrade> grade) {
		this.grade = grade;
	}
	 ...
	 */
	public java.util.Set<com.tucao.bbs.entity.Attachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.Set<com.tucao.bbs.entity.Attachment> attachments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.bbs.entity.BbsPost)) return false;
		else {
			com.tucao.bbs.entity.BbsPost bbsPost = (com.tucao.bbs.entity.BbsPost) obj;
