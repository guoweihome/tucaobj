...
public abstract class BaseBbsPostType  implements Serializable {
	...
	private com.tucao.bbs.entity.BbsPostType parent;

	// collections
	private java.util.Set<com.tucao.bbs.entity.BbsPostType> childs;
	private java.util.Set<com.tucao.bbs.entity.BbsUserGroup> groups;
	 ...
	 */
	public com.tucao.bbs.entity.BbsPostType getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.tucao.bbs.entity.BbsPostType parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.tucao.bbs.entity.BbsPostType> getChilds () {
		return childs;
	}
	 ...
	 */
	public void setChilds (java.util.Set<com.tucao.bbs.entity.BbsPostType> childs) {
		this.childs = childs;
	}
	 ...
	 */
	public java.util.Set<com.tucao.bbs.entity.BbsUserGroup> getGroups () {
		return groups;
	}
	 ...
	 */
	public void setGroups (java.util.Set<com.tucao.bbs.entity.BbsUserGroup> groups) {
		this.groups = groups;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.bbs.entity.BbsPostType)) return false;
		else {
			com.tucao.bbs.entity.BbsPostType bbsPostType = (com.tucao.bbs.entity.BbsPostType) obj;
