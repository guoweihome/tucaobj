...
public abstract class BaseBbsCreditExchange  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.bbs.entity.BbsCreditExchange)) return false;
		else {
			com.tucao.bbs.entity.BbsCreditExchange bbsCreditExchange = (com.tucao.bbs.entity.BbsCreditExchange) obj;
