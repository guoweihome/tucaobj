...
public abstract class BaseBbsVoteRecord  implements Serializable {
	...
	private com.tucao.bbs.entity.BbsVoteTopic topic;
	 ...
	 */
	public com.tucao.bbs.entity.BbsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.tucao.bbs.entity.BbsVoteTopic topic) {
		this.topic = topic;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.bbs.entity.BbsVoteRecord)) return false;
		else {
			com.tucao.bbs.entity.BbsVoteRecord bbsVoteRecord = (com.tucao.bbs.entity.BbsVoteRecord) obj;
