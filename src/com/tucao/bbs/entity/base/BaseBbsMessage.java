...
public abstract class BaseBbsMessage  implements Serializable {
	...
	// many to one
	private com.tucao.bbs.entity.BbsUser user;
	private com.tucao.bbs.entity.BbsUser sender;
	private com.tucao.bbs.entity.BbsUser receiver;

	// collections
	private java.util.Set<com.tucao.bbs.entity.BbsMessageReply> reply;
	 ...
	 */
	public com.tucao.bbs.entity.BbsUser getUser () {
		return user;
	}
	 ...
	 */
	public void setUser (com.tucao.bbs.entity.BbsUser user) {
		this.user = user;
	}
	 ...
	 */
	public com.tucao.bbs.entity.BbsUser getSender () {
		return sender;
	}
	 ...
	 */
	public void setSender (com.tucao.bbs.entity.BbsUser sender) {
		this.sender = sender;
	}
	 ...
	 */
	public com.tucao.bbs.entity.BbsUser getReceiver () {
		return receiver;
	}
	 ...
	 */
	public void setReceiver (com.tucao.bbs.entity.BbsUser receiver) {
	 ...
	 */
	public java.util.Set<com.tucao.bbs.entity.BbsMessageReply> getReply () {
		return reply;
	}
	 ...
	 */
	public void setReply (java.util.Set<com.tucao.bbs.entity.BbsMessageReply> reply) {
		this.reply = reply;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.bbs.entity.BbsMessage)) return false;
		else {
			com.tucao.bbs.entity.BbsMessage bbsMessage = (com.tucao.bbs.entity.BbsMessage) obj;
