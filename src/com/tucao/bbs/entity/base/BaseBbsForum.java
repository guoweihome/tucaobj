...
public abstract class BaseBbsForum implements Serializable {
	 ...
	 */
	public BaseBbsForum(java.lang.Integer id,
			com.tucao.bbs.entity.BbsCategory category,
			com.tucao.core.entity.CmsSite site, java.lang.String path,
	...
	private com.tucao.bbs.entity.BbsCategory category;
	private com.tucao.core.entity.CmsSite site;

	// collections
	private java.util.Set<com.tucao.bbs.entity.BbsPostType> postTypes;
	 ...
	 */
	public com.tucao.bbs.entity.BbsCategory getCategory() {
		return category;
	}
	 ...
	 */
	public void setCategory(com.tucao.bbs.entity.BbsCategory category) {
	...
	public java.util.Set<com.tucao.bbs.entity.BbsPostType> getPostTypes() {
		return postTypes;
	}

	public void setPostTypes(
			java.util.Set<com.tucao.bbs.entity.BbsPostType> postTypes) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.tucao.bbs.entity.BbsForum))
			return false;
		else {
			com.tucao.bbs.entity.BbsForum bbsForum = (com.tucao.bbs.entity.BbsForum) obj;
