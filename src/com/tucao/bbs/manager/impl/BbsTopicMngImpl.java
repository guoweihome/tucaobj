...
import com.tucao.bbs.Constants;
import com.tucao.bbs.MagicConstants;
import com.tucao.bbs.cache.BbsConfigEhCache;
import com.tucao.bbs.dao.BbsTopicDao;
...
import com.tucao.bbs.web.OnlineCountListener;
...
import com.tucao.core.web.MagicMessage;
...
public class BbsTopicMngImpl implements BbsTopicMng {
	...
	public List<BbsTopic> getListTopShow(Integer page){
		return dao.getListTopShow(page);
	}

	public List<BbsTopic> getNewList(Integer count) {
		return dao.getNewList(count);
	}
	public List<BbsTopic> getNewList(Integer count,String datetime) {
		// TODO Auto-generated method stub
		return dao.getNewList(count,datetime);
	}
	
	public List<BbsTopic> getShuoshList(Integer count){
		return dao.getShuoshList(count);
	}
	/**
	 *  使用道具
	 */
