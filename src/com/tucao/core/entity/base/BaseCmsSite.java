package com.tucao.core.entity.base;
...
public abstract class BaseCmsSite implements Serializable {
	 ...
	 */
	public BaseCmsSite(java.lang.Integer id,
			com.tucao.core.entity.CmsConfig config, java.lang.String domain,
	...
	// many to one
	private com.tucao.core.entity.Ftp uploadFtp;
	private com.tucao.core.entity.CmsConfig config;
	private com.tucao.bbs.entity.BbsCreditExchange creditExchange;
	 ...
	 */
	public com.tucao.core.entity.Ftp getUploadFtp() {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp(com.tucao.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.tucao.core.entity.CmsConfig getConfig() {
		return config;
	}
	 ...
	 *            the config_id value
	 */
	public void setConfig(com.tucao.core.entity.CmsConfig config) {
		this.config = config;
	}

	public com.tucao.bbs.entity.BbsCreditExchange getCreditExchange() {
		return creditExchange;
	}

	public void setCreditExchange(
			com.tucao.bbs.entity.BbsCreditExchange creditExchange) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.tucao.core.entity.CmsSite))
			return false;
		else {
			com.tucao.core.entity.CmsSite cmsSite = (com.tucao.core.entity.CmsSite) obj;
