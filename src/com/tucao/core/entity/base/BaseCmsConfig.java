...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.tucao.core.entity.MarkConfig m_markConfig;
	...
	public com.tucao.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.tucao.core.entity.MarkConfig m_markConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tucao.core.entity.CmsConfig)) return false;
		else {
			com.tucao.core.entity.CmsConfig cmsConfig = (com.tucao.core.entity.CmsConfig) obj;
