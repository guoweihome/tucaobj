package com.tucao.common.image;
...
import com.tucao.common.image.ImageUtils.Position;
...
public class MagickImageScale {
	...
	public static void main(String[] args) throws Exception {
		...
		MagickImageScale.resizeFix(
				new File("test/com/tucao/common/util/1.bmp"), new File(
						"test/com/tucao/common/util/1-n-3.bmp"), 310, 310, 50,
				50, 320, 320);
