package com.tucao.common.web;

import static com.tucao.common.web.Constants.POST;
...
public class RequestUtils {
	...
	public static String getQueryParam(HttpServletRequest request, String name) {
		...
		try {
			...
			System.out.println("ceshi s query:"+s);
	...
	public static String getLocation(HttpServletRequest request) {
		...
		//System.out.println("uri:"+uri+" "+"urL:"+request.getRequestURL()+" "+"buff:"+buff.toString()+" "+"origUri:"+origUri+" ");
